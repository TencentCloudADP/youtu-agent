...
from ..utils import get_logger, SimplifiedAsyncOpenAI, FileUtils


logger = get_logger(__name__)
PROMPTS = FileUtils.load_prompts(pathlib.Path(__file__).parent / "document_processing" / "document_processing_prompts.yaml")
