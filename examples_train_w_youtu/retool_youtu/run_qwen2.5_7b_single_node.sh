...
source ~/miniconda3/bin/activate agent-lightning
# ================= Model Configuration =================
...
# ================= Experiment =================
PROJECT_DIR="$(pwd)"
experiment_name=qwen2.5-7b_dapo_retool_youtu_test_3
...
CUSTOM_DATASET_PATH="${PROJECT_DIR}/examples_train_w_youtu/retool/retool.py"
...
# ================= Training Log File =================
TRAINING_LOG_FILE=$AGENT_LOG_DIR/${experiment_name}_algorithm_training.log
echo "Training output will be saved to: $TRAINING_LOG_FILE"
...
AGL_MANAGED_STORE=0 AGL_CURRENT_ROLE=algorithm python train_calc_sandbox_agent.py \
    ...
    trainer.total_training_steps=200 2>&1 | tee -a "$TRAINING_LOG_FILE"
