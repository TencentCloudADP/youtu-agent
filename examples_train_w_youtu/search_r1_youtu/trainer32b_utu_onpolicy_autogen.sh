...
agl store --port 9999 & 
sleep 60
AGL_MANAGED_STORE=0 python3 examples_train_w_youtu/search_r1_youtu/train_search_agent.py qwen32b --external-store-address http://localhost:9999 --n-runners 32
